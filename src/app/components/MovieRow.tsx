...
const MovieCard = ({ index }: MovieCardProps) => {
  return (
    <div
      ...
      transform bg-gradient-to-t from-transparent to-black transition duration-200 ease-in  hover:z-50
      hover:scale-110 md:h-40 md:min-w-[250] lg:h-52 lg:min-w-[350px]
      '
    >
      <Image
        key={index}
