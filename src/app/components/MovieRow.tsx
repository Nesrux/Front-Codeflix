...
const MovieCard = ({ movie }: { movie: Movie }) => (
  <div className='group relative min-h-[12vh] rounded bg-zinc-900 md:min-h-[12vh]'>
    <Image
      alt={movie.title}
    ...
    />
    <div className='invisible absolute top-8 z-10 w-full min-w-[20vh] scale-0 opacity-0 transition delay-300 duration-300 group-hover:-translate-y-[6vw] group-hover:scale-110 group-hover:opacity-100 sm:visible'>
      <Image
        alt={movie.title}
        src={movie.bannerFileURL}
        width={600}
        height={400}
        className='duration h-[12vw] w-full cursor-pointer rounded-t-md object-cover object-right-top shadow-xl transition'
      />
